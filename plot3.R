...
with(fdata, plot(ftd, Sub_metering_1, type="l", xlab="Day", ylab="Energy sub metering"))
	lines(fdata$ftd, fdata$Sub_metering_2,type="l", col= "red")
	lines(fdata$ftd, fdata$Sub_metering_3,type="l", col= "blue")
